...
func genScheduler(instanceID string, enableTrace bool, tracerProvider *trace.TracerProvider, scheduleOperator schedule_operator.Operator, client discovery.ExecutorDiscoveryClient, schedulerWorkerCount int) (*Scheduler, error) {
	...
	scheduler := newSchedulerInner(instanceID, tracerProvider, enableTrace, scheduleOperator, scheduleService, statisticsService, executorRouteService, executorManageService, jobService, triggerService, onFireService)
